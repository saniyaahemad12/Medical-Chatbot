...
sym_des = pd.read_csv(dataset_path("symtoms_df.csv"))
...
def find_doctors():
    ...
    if not doctors:
        doctors = [
            {"lat": lat + 0.01, "lon": lon + 0.01, "name": "Dr. Ramesh", "address": "123 Clinic Street"},
            {"lat": lat - 0.01, "lon": lon - 0.01, "name": "Dr. Priya", "address": "456 Health Avenue"}
        ]
