...
print("Available diseases in description:", description['Disease'].unique())
print("Available diseases in precautions:", precautions['Disease'].unique())
print("Available diseases in medications:", medications['Disease'].unique())
print("Available diseases in diets:", diets['Disease'].unique())
print("Available diseases in workout:", workout['disease'].unique())
def helper(dis):
        ...
        if symptoms =="Symptoms":
          ...
          # ...existing code...
            ...
            if precautions and len(precautions) > 0:
                my_precautions = [p for p in precautions[0] if p]  # Avoid empty strings
